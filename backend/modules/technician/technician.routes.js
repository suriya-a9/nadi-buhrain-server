const { assignedServices, servicesList, inventory, startWork, onHoldService, updateServiceStatus, paymentRaise, listNotification, getServiceTimer } = require('./technician.controller');
