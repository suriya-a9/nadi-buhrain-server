module.exports = function accountVerificationStatusTemplate({ name, status, reason }) {
        ...
        <div style="font-family: Arial, sans-serif; background:#f4f6f8; padding:30px;">
                            ...
                            <tr>
                                <td>
                                    <h2 style="color:#1f2937;">
                                        Account Verification ${isVerified ? "Approved" : "Update"}
                                    </h2>
            ...
            ? `
                                            <p style="color:#4b5563;">
                                                ...
                                                <strong style="color:#16a34a;">successfully verified</strong>.
                                            </p>
